                        ...
                        },
                        {
                            ...
                            children: <div className="row">
                                <div className="col-sm-12">
                                    <div className="p-4">
                                        <div className="row">
                                            <div className="border-end col-6 col-md-3">
                                            ...
                                            <div className="border-end col-6 col-md-3">
                                                ...
                                                <br />
                                                <p className="text-muted">VietNam</p>
                                            </div>
                                        </div>
                                        <p className="mt-4">Alexander Smith is our booking systems manager, who ensures that every medical booking process runs smoothly and efficiently. With more than 10 years of experience in the field of medical information systems management, Alexander brings professionalism and dedication to every aspect of his work.</p><p>He is always focused on improving the patient experience and ensuring that all their needs are met in a timely manner. With his excellent leadership skills and deep understanding of technology, Alexander has helped optimize our booking system, making the appointment process easier and more convenient for everyone.</p>
                                        <h4 className="font-medium mt-4" style={{ clear: 'both' }}>Skill Set</h4>
                                        <hr />
                                        <h5 className="mt-4">Wordpress <span className="float-end">80%</span></h5>
                                        <div className="progress">
                                            <div className="progress-bar" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style={{ width: "10%" }}>
                                            </div>
                                        </div>
                                        <h5 className="mt-4">HTML 5 <span className="float-end">90%</span></h5>
                                        <div className="progress"><div className="progress-bar bg-success" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style={{ width: "25%" }}>
                                        </div></div><h5 className="mt-4">jQuery <span className="float-end">50%</span>
                                        </h5>
                                        <div className="progress"><div className="progress-bar bg-info" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style={{ width: "50%" }}>
                                        </div>
                                        </div>
                                        <h5 className="mt-4">Photoshop <span className="float-end">70%</span></h5>
                                        <div className="progress"><div className="progress-bar bg-warning" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style={{ width: "75%" }}>
                                        </div>
                                        </div>
                                    </div>
                                </div>
